...
#
def window_to_rgb(imagefile,label,coord = (0,0), window_frame = [50,50],name=""):
    ...
    #
    window = NIL.read_data_multithread([(x,y)],npixx = window_frame[0],npixy = window_frame[1],color_mode="RGBA")
